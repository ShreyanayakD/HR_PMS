...
def display_company_info():
    ...
    """)
    st.image("C:/Users/SHREYA/Desktop/DBDWI/pms HR/Company.jpg", use_container_width=True)
...
def display_business_insights():
    ...
    if insights:
        ...
        if insights['employees_by_dept']:
            ...
            dept_count_chart = alt.Chart(dept_count_df).mark_bar(color='#f28e2b').encode(
